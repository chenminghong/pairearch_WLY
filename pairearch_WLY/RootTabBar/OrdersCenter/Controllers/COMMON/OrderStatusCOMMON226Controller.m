//
//  OrderStatusCOMMON226Controller.m
//  pairearch_WLY
//
...
@interface OrderStatusCOMMON226Controller ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation OrderStatusCOMMON226Controller
...
- (CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section {
    NSString *desStr = [OrderStatusManager getOrderDescriptionWithStatus:ORDER_STATUS_226 orderType:ORDER_TYPE_COMMON];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    label.text = [OrderStatusManager getOrderDescriptionWithStatus:ORDER_STATUS_226 orderType:ORDER_TYPE_COMMON];
    return header;
}
...
//                [weakself.navigationController pushViewController:checkVC animated:YES];
                ...
                NSInteger orderStatus = [OrderStatusManager getNextProcessWithCurrentStatus:ORDER_STATUS_226 orderType:ORDER_TYPE_COMMON];
