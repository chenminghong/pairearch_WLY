...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    NSString *titleText = [OrderStatusManager getOrderDescriptionWithStatus:ORDER_STATUS_212 orderType:ORDER_TYPE_BACK];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) {
        cell.descriptionLabel.text = [OrderStatusManager getOrderDescriptionWithStatus:ORDER_STATUS_212 orderType:ORDER_TYPE_BACK];
    } else {
