...
@protocol AbnormalReportDelegate <NSObject>
...
@property (weak, nonatomic) IBOutlet UILabel *loadAddressLabel;         //发货地址
...
@property (weak, nonatomic) IBOutlet UIButton *abnormalReportBtn;
...
@property (nonatomic, weak) id <AbnormalReportDelegate>abnormalDelegate;        //异常上报按钮代理
