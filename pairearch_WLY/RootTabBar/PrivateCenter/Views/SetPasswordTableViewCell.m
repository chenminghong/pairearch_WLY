...
@implementation SetPasswordTableViewCell
...
- (void)createSubviews
{
    ...
    //设置密码cell前面的图标
    UIImageView *iconImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"personal1.png"]];
